...
#
# INV-HPSCR-NM.rb
# Test "happy path" conditions as an Investigator
# No menu testing due to UI changes - 1/21/14
#
# Scott Wedel
# 14 January 2014
#
# Tests from the 'INV Script' sheet in the QC Test Modules V1.0 spreadsheet
#
####################################################################################
...
salog( sep, "LOG" )
salog( 'INVESTIGATOR ROLE: \'HAPPY PATH\' AUTOMATED TESTS', "LOG" )
...
utst = b.text.include? 'Hi, Inv Site1,2,3'
