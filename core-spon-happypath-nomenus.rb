...
#
# SPON-HPSCR-NM.rb
# Test "happy path" conditions as a Sponsor
# No menus
#
# Scott Wedel
# 21 January 2014
#
# Tests from the 'SP Script' sheet in the QC Test Modules V1.0 spreadsheet
#
####################################################################################
...
# TEST #1: Login as Sponsor
tst = "1 - LOGIN"
salog( tst, "LOG" )
salog( sep, "LOG" )

tst = '1.1: Login as Sponsor'
...
exone = b.text.include? '101-Demo 108'
...
# TEST 6: view queries in query manager, QM column sorting
